export const projects = [
  {
    ...
    description:
      "I Implemented a command for UBC Orbit's ALEASAT satellite that output a Hello message. The command was tested the code by manually flashing to a Hercules microcontroller and writing a hardware in the loop test in Python",
    image: "./project-1.gif",
  ...
  },
  {
    ...
    description:
      "In the class Computing Systems I, I created a Turing Complete reduced instruction set machine (RISC) in Verilog. This project spanned 3 months and was debugged using ModelSim test benches, RTL gate level simulation and testing on a DE1-SOC FPGA.",
    image: "./project-2.gif",
